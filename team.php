...
<body>
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-md-4">
        <img src="images/ChiefsTeam.jpg" class="img-responsive pull-left" alt="ChiefsTeam">
      </div>
...
<div class="container-fluid">
  <div class="row">
    ...
    $sql= "SELECT  num, fname, lname, pos FROM team where id < 11";
    ...
    $sql= "SELECT num, fname, lname, pos FROM team where id >10";
    $result = mysqli_query($conn, $sql);
